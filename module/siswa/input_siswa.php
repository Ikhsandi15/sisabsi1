...
if($_GET['act']=="input"){
  ...
  <?php
	...
	$sqla=$conn->query("select * from sekolah where id='$rs[id]'");
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
<?php
                            	$sql=$conn->query("select * from siswa where ids='$_GET[ids]'");
...
<?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kelas">
  <?php
 	$sqlc=$conn->query("select * from kelas");
	while($rsc=mysqli_fetch_array($sqlc)){
	$sqla=$conn->query("select * from sekolah where id='$rsc[id]'");
	$rsa=mysqli_fetch_array($sqla);
if($_SESSION['level']=="admin_guru"){
if($rsa['id']==$_SESSION['id']){
